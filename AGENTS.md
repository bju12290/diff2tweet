...
- Language: Python
- CLI entrypoint: `diff2tweet`
- Config: YAML file with a validator
- Default LLM provider: OpenAI (BYO API key)
...
2. **Milestone 2:** Local LLMs (Ollama/LMStudio), Codex + Gemini support, git hook integration
